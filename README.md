...
- Handles details about connecting to the right url.<p>
3: main_functions.py<p>
- These functions are imported into main.py<p>
4: main.py<p>
- This is where you enter the name of the stop and how many departures you would like returned<p>
- Make sure spelling is correct. (Not case sensitive)<p>

Gitignore:<p>
1: token.txt<p>
- Textfile that stores the token generated by the API. Before running the code for the first time, create token.txt in the same directory as the other files, and everything should work fine.<p>
2: account_details.py<p>
- Contains personal keys to grant access to the API.<p>
- Create an account here: https://developer.vasttrafik.se/<p>
